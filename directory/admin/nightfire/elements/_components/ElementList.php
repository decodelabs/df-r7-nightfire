...
// Slug
    public function addSlugField($list) {
        $list->addField('slug', function($element) {
            return $this->import->component('ElementLink', '~admin/nightfire/elements/', $element)
...
// Actions
    public function addActionsField($list) {
        $list->addField('actions', function($element) {
            return [
                // Edit
                $this->import->component('ElementLink', '~admin/nightfire/elements/', $element, $this->_('Edit'))
                    ->setAction('edit'),

                // Delete
                $this->import->component('ElementLink', '~admin/nightfire/elements/', $element, $this->_('Delete'))
                    ->setAction('delete')
            ];
        });
    }
